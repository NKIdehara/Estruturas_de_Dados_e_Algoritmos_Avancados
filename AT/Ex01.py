...
sistema_operacional = MinHeap()
for processo in processos:
    sistema_operacional.insert(processo)

sistema_operacional.change("35211feb-d322-4267-9e92-6e3d743ce6c1", 0)

while len(sistema_operacional.heap) > 0:
    prioridade, uid, tempo = sistema_operacional.pop()
    print(f"ID do processo: {uid}\tTempo de execução: {tempo}\tPrioridade: {prioridade}")
